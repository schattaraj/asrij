      ...
      <ul>
        ...
        <nav class="navbar navbar-light">
            ...
            <div class="d-flex align-items-center">
                <a href="#exampleModal" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary d-none d-md-block">Login</a>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <ul class="links">
                        ...
                        <li><i class="fa-solid fa-angles-right"></i> <a href="#registration-section">Register</a></li>
                        <li><i class="fa-solid fa-angles-right"></i> <a href="#exampleModal" data-bs-toggle="modal" data-bs-target="#exampleModal">Login</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <ul>
          ...
          <form autocomplete="off">
            <div class="mb-3">
              <div class="form-floating">
                <input type="email" class="form-control" autocomplete="off" id="email" placeholder="name@example.com" required>
